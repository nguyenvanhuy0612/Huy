...
NEW_QUEUE_CHECK_LOC = "//div[@class='neo-sheet__content']"
NEW_QUEUE_CANCEL_BTN_LOC = "//div[@id='gcomp_content']//button[text()='Cancel']"
NEW_QUEUE_DISCARD_BTN_LOC = "//div[@role='document']//button[text()='Discard']"
