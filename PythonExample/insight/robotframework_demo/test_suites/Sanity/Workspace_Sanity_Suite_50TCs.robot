...
#    ...    AvayaIX.Close AvayaIX    AND
    ...
    outlookLib.Customer Sent An Email      ${BL_AGENT1.MAIL1}     ${SUBJECT_MAIL1}      ${MESSAGE_EMAIL1}    ${EMPTY}    ${CUST1_EMAIL}
    Sleep   10
    ...
    WebChat.Open Browser To Webchat Page    ${BROWSER_CUST_1}    ${BROWSER_CUST_ALIAS_1}
    WebChat.Customer Init A Chat Session     ${CUST1_INFO}    ${EMAIL_CHATSCRIPT_NO}    ${BL_AGENT1.SKILLSET_WC1}
...
#    ...     OneXCommunicator.Close OneX      AND
    ...
    WorkCard.Verify Working Contact   ${CUST8.PHONE_E164}
    Sleep   1
...
Workspaces_TC-24 - Make sure Agent on Workspaces can chat with Customer after reload browser
    ...
    Sleep   2
    Switch Browser      ${BROWSER_CUST_ALIAS_1}
    WebChat.Verify Message On Customer Chat     ${BL_AGENT1.FIRSTNAME}     Hello Customer, I'm Agent
    ...
    Sleep   5
    Switch Browser      ${BROWSER_CUST_ALIAS_1}
    WebChat.Verify Message On Customer Chat     ${BL_AGENT1.FIRSTNAME}     OK. Let me see...
...
Workspaces_TC-25 - Time in the state of the agent is reset after the agent changes status
    ...
    Wait Until Agent Status Changes To    Ready     5
...
#    ...     AgentToolbar.Agent Go Ready     AND
    ...
    WidgetWelcomePage.Search Agent Team     ${MM_AGENT2.FULLNAME}      ${MM_AGENT2.ID}
...
#    ...     AvayaIX.Close AvayaIX    AND
    ...
    Switch Browser      ${BROWSER_AGENT_ALIAS_1}
    Sleep   1
    AgentToolbar.Address Book Call Out     ${BL_AGENT2.PHONE_NUMBER}
    ...
    WorkCard.Agent Ends A Contact     ${BL_AGENT1.PHONE_NUMBER}
...
Workspaces_TC-33 - Make sure Agent can transfer WC to service to another Agent
    ...
    Login.Login Agent    ${BROWSER_AGENT_2}    ${BROWSER_AGENT_ALIAS_2}    ${BL_AGENT2.USERNAME}    ${BL_AGENT2.PASSWORD}
    Login.Activate Agent
    Sleep   1
    AgentToolbar.Agent Start Work
    Sleep   1
    ...
    Switch Browser      ${BROWSER_AGENT_ALIAS_1}
    WorkCard.Transfer To Service      ${CUST1_EMAIL}      ${BL_AGENT2.SKILLSET_WC1}
    Sleep   5
...
#    ...     OneXCommunicator.Close OneX      AND
    ...
    CustomerDetails.Verify Intrinsics        ${CUST8.PHONE}     ${CDN1_URI}   ${CDN1}   ${AGENT2_PHONE_NUMBER}    ${CUST1_PHONE}   ${AGENT2_SKILLSET_VOICE1}
...
#    ...     AvayaIX.Setting Telephony   ${AGENT2_PHONE_NUMBER}   ${PHONE2_PASSWORD}    ${SERVER_SM}    ${PORT}    ${DOMAIN}     AND
    ...
    ...     Sleep   1       AND
    #   Login blended agent to workspaces, start work and go ready
    ...     Login.Login Agent    ${BROWSER_AGENT_2}    ${BROWSER_AGENT_ALIAS_2}    ${BL_AGENT1.USERNAME}    ${BL_AGENT1.PASSWORD}     AND
    ...     Login.Activate Agent    AND
    ...     AgentToolbar.Agent Start Work   AND
    ...     AgentToolbar.Agent Go Ready     AND
    ...     Sleep   1
...
#    ...     OneXCommunicator.Close OneX      AND
    ...
    WorkCard.Agent Hold A Contact    ${CUST8.PHONE_E164}
    Sleep   2
...
#    ...     OneXCommunicator.Close OneX      AND
    ...
    WorkCard.Transfer Team Call      ${CUST8.PHONE}      ${BL_AGENT2.FULLNAME}
    Sleep   1
...
#    ...     OneXCommunicator.Close OneX      AND
    ...
    Switch Browser      ${BROWSER_AGENT_ALIAS_1}
    WorkCard.Agent Transfer Contact     ${CDN_55086}
    Sleep   3
...
#    ...     OneXCommunicator.Close OneX      AND
    ...
    WorkCard.Consult Extension Call       ${CUST8.PHONE}      ${BL_AGENT2.PHONE_NUMBER}
    Sleep   1
    ...
    Switch Browser      ${BROWSER_AGENT_ALIAS_1}
    WorkCard.Agent Consult Contact     ${BL_AGENT2.PHONE_NUMBER}
    Sleep   3
...
#    ...     OneXCommunicator.Close OneX      AND
    ...
    Switch Browser      ${BROWSER_AGENT_ALIAS_1}
    WorkCard.Agent Consult Contact     ${CDN_55086}
    Sleep   3
...
#    ...     AvayaIX.Close AvayaIX    AND
    ...
    Switch Browser      ${BROWSER_AGENT_ALIAS_1}
    WorkCard.Agent Accepts A Contact     ${BL_AGENT2.PHONE_E164}
    Sleep   2
...
Workspaces_TC-47 - Blended Agent can process an email with attachment
    [Documentation]  Blended Agent can process an email with attachment
    [Setup]     Run Keywords
    #   Login blended agent 1 to workspaces, start work and go ready
    ...     Login.Login Agent    ${BROWSER_AGENT_1}    ${BROWSER_AGENT_ALIAS_1}    ${BL_AGENT2.USERNAME}    ${BL_AGENT2.PASSWORD}     AND
    ...     Login.Activate Agent    AND
    ...     AgentToolbar.Agent Start Work   AND
    ...     AgentToolbar.Agent Go Ready     AND
    ...     Sleep   1
    ...
    # STEP 1: Open Outlook, from customer sent to Server the Email without attachment
    Utils.TEST CASE HAS RUN INTO STEP    STEP 01    Open Outlook, from customer sent to Server the Email without attachment
    ${file attach}=     Set Variable    file_email_attachment.txt
    outlookLib.Customer Sent An Email      ${MM_AGENT2.MAIL1}     ${SUBJECT_MAIL1}      ${MESSAGE_EMAIL1}    ${file attach}    ${CUST1_EMAIL}
    Sleep   10
    ...
    WorkCard.Agent Accepts A Contact     ${CUST1_EMAIL}
    Sleep   1
    WidgetEmail.Verify Email Attachment     ${CUST1_EMAIL}   ${file attach}
    Sleep   3
...
Workspaces_TC-48 - Blended Agent can reply an Email without attachment
    ...
    Should Contain    ${data}[0]    ${SUBJECT_MAIL1}
    Should Contain    ${data}[1]    ${MM_AGENT2.MAIL1}
    Should Contain    ${data}[2]    ${CUST1_EMAIL}
...
Workspaces_TC-50 -Agent can Transfer Email to a service
    ...
    WorkCard.Transfer To Service      ${CUST1_EMAIL}      ${MM_AGENT2.SKILLSET_EM}
    Sleep   1
