...
*** Settings ***
Documentation    This resource provides the Library keyword and User keyword
...
Library     ../keywords/workspace/web_statistic/WebStatisticLocator.py

#Resource    ../keywords/workspace/WorkspacesKeyword.robot
...
#${CUST2_EMAIL}        quy_em5@acc7dc.com    #WS_CUSTOMER2@acc7dc.com   #WS_EM_customer2@automation.tma.com
...
#${SUP_VOICE_URI}         sip:${SUP_PHONE_NUMBER}@aoc.com     #sip:${AGENT0_PHONE_NUMBER}@auracc8.com
...
#${AGENT1_VOICE_URI}         sip:${AGENT1_PHONE_NUMBER}@aoc.com     #sip:${AGENT1_PHONE_NUMBER}@auracc8.com
...
#${AGENT2_VOICE_URI}         sip:${AGENT2_PHONE_NUMBER}@aoc.com      #sip:${AGENT2_PHONE_NUMBER}@auracc8.com
...
#${AGENT3_VOICE_URI}         sip:${AGENT3_PHONE_NUMBER}@aoc.com      #sip:${AGENT3_PHONE_NUMBER}@auracc8.com
...
#${AGENT4_VOICE_URI}         sip:${AGENT4_PHONE_NUMBER}@aOC.com      #sip:${AGENT4_PHONE_NUMBER}@auracc8.com
...
##${AGENT5_VOICE_URI}         sip:${AGENT5_PHONE_NUMBER}@aoc.com      #sip:${AGENT5_PHONE_NUMBER}@auracc8.com
